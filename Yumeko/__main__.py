...
buttons = [
    [
        InlineKeyboardButton(text="➕ Add Destiny To Your group ➕", url="http://t.me/?startgroup=true"),
    ],
    [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I Aᴍ Aʟɪᴠᴇ](https://telegra.ph/file/a01fd21c07d68b8550b3a.jpg), parse_mode=ParseMode.MARKDOWN")
        except Unauthorized:
            LOGGER.warning(
